...
export class CryptoService {
  ...
  /**
   * Base64エンコード（Uint8Arrayから）
   */
  static base64Encode(uint8Array) {
   ...
   */
  static async calculateHmacSha256(hmacKey, message) {
